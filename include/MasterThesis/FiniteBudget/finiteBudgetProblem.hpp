#ifndef MASTER_THESIS_FINITE_BUDGET_MODEL_HEADER_FILE
#define MASTER_THESIS_FINITE_BUDGET_MODEL_HEADER_FILE
...
class FiniteBudgetModel {
    public:
        enum { RIGHT = 0, LEFT = 1 };

        FiniteBudgetModel(unsigned worldWidth, double leftP, size_t maxBudget, double discount);
